...
public class FormInteraction {
    public static void main(String[] args) {
        ...
        try {
            ...
            By loginButtonSel = By.cssSelector("button[type='submit']");

            // Find element
            WebElement usernameElem = driver.findElement(usernameSel);
            WebElement passwordElem = driver.findElement(passwordSel);
            WebElement loginButtonElem = driver.findElement(loginButtonSel);
            ...
            loginButtonElem = driver.findElement(loginButtonSel);
